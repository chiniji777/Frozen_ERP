...
dbdRoute.post("/save-to-customer", async (c) => {
  ...
  if (body.customerId) {
    ...
    await db.update(customers)
      .set({
        ...
        province: lookup.province || existing.province,
        district: lookup.district || existing.district,
        subDistrict: lookup.subDistrict || existing.subDistrict,
        zipCode: lookup.zipCode || existing.zipCode,
  ...
  if (existingByTax) {
    await db.update(customers)
      .set({
        ...
        province: lookup.province || existingByTax.province,
        district: lookup.district || existingByTax.district,
        subDistrict: lookup.subDistrict || existingByTax.subDistrict,
        zipCode: lookup.zipCode || existingByTax.zipCode,
        phone: lookup.phone || existingByTax.phone,
  ...
  const result = await db.insert(customers).values({
    ...
    subDistrict: lookup.subDistrict || null,
    zipCode: lookup.zipCode || null,
